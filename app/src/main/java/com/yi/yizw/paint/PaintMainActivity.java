...
public class PaintMainActivity extends Activity {
    ...
    protected void saveBitmap() {
        try {
            ...
            Toast.makeText(PaintMainActivity.this, "保存图片成功", Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(PaintMainActivity.this, "保存图片失败", Toast.LENGTH_LONG).show();
            e.printStackTrace();
        }
    }
    ...
    protected void resumeCanvas() {
        ...
        if (baseBitmap != null) {
            ...
            canvas.drawColor(Color.WHITE);
            iv_canvas.setImageBitmap(baseBitmap);
            Toast.makeText(PaintMainActivity.this, "清除画板成功，可以重新开始绘图", Toast.LENGTH_LONG).show();
        }
    }
